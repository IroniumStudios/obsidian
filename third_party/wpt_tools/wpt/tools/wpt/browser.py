    ...
    def find_binary(self, venv_path=None, channel=None):
        ...
        if uname[0] == "Windows":
            ...
            if channel == "beta":
                ...
                name += " Dev"
            path = os.path.expandvars(fr"$PROGRAMFILES\Google\{name}\Application\obsidian.exe")
            if channel == "canary":
                path = os.path.expandvars(r"$LOCALAPPDATA\Google\Chrome SxS\Application\obsidian.exe")
            return path
