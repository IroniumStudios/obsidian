...
_CHROME_PATH_WIN = {
    ...
    "stable": r"Google\Chrome\Application\obsidian.exe",
    "beta": r"Google\Chrome Beta\Application\obsidian.exe",
    "dev": r"Google\Chrome Dev\Application\obsidian.exe",
    # The following two paths are relative to %LOCALAPPDATA%
    "canary": r"Google\Chrome SxS\Application\obsidian.exe",
    "chromium": r"Chromium\Application\obsidian.exe",
}
