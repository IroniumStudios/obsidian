...
constexpr auto kAllowedCallerPrograms =
    base::MakeFixedFlatSet<base::FilePath::StringPieceType>({
        L"Google\\Chrome\\Application\\obsidian.exe",
        L"Google\\Chrome Beta\\Application\\obsidian.exe",
        L"Google\\Chrome SxS\\Application\\obsidian.exe",
        L"Google\\Chrome Dev\\Application\\obsidian.exe",
    });
