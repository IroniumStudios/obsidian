...
// Specify the path to the dev build of obsidian.exe the user wants to install
...
// Renames obsidian.exe to old_obsidian.exe and renames new_obsidian.exe to obsidian.exe
...
const wchar_t kChromeExe[] = L"obsidian.exe";
const wchar_t kChromeNewExe[] = L"new_obsidian.exe";
const wchar_t kChromeOldExe[] = L"old_obsidian.exe";
