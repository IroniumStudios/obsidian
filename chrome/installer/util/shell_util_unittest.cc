...
TEST_F(ShellUtilShortcutTest, RemoveMultipleChromeShortcuts) {
  // Shortcut 1: targets "obsidian.exe"; no arguments.
  ...
  // Shortcut 2: targets "obsidian.exe"; has arguments; icon set to "other.ico".
  ...
  // Shortcut 3: targets "iron.exe"; has arguments; icon set to "obsidian.exe".
  ...
  // Remove shortcuts that target "obsidian.exe".
  ASSERT_TRUE(ShellUtil::RemoveShortcuts(ShellUtil::SHORTCUT_LOCATION_DESKTOP,
                                         ShellUtil::CURRENT_USER,
                                         {chrome_exe_}));
...
TEST_F(ShellUtilShortcutTest, RemoveMultiTargetShortcuts) {
  ...
  // Shortcut 4: targets "iron.exe"; has arguments; icon set to "obsidian.exe".
  ...
  // Remove per-user shortcuts that target "obsidian.exe", "chrome_proxy.exe" and
  // "iron.exe".
...
TEST_F(ShellUtilShortcutTest, RemoveSystemLevelMultiTargetShortcuts) {
  ...
  // Remove system level shortcuts that target "obsidian.exe", "chrome_proxy.exe"
  // and "iron.exe".
  ASSERT_TRUE(ShellUtil::RemoveShortcuts(
...
TEST_F(ShellUtilShortcutTest, RemoveAllShortcutsMultipleLocations) {
  // Shortcut 1: targets "obsidian.exe"; desktop shortcut.
...
TEST_F(ShellUtilShortcutTest, RetargetChromeShortcutsWithArgsEmpty) {
  ...
  // Shortcut 2: targets "obsidian.exe"; has arguments.
  test_properties_.set_shortcut_name(L"Chrome 2");
  test_properties_.set_arguments(L"--profile-directory=\"Profile 2\"");
  ASSERT_TRUE(ShellUtil::CreateOrUpdateShortcut(
      ShellUtil::SHORTCUT_LOCATION_DESKTOP, test_properties_,
  ...
  // Retarget shortcuts: replace "obsidian.exe" with "manganese.exe". Only
...
TEST_F(ShellUtilShortcutTest, RetargetChromeShortcutsWithArgsIcon) {
  ...
  // Shortcut 1: targets "obsidian.exe"; icon same as target.
  test_properties_.set_shortcut_name(L"Chrome 1");
  ...
  // Shortcut 2: targets "obsidian.exe"; icon set to "other.ico".
  test_properties_.set_shortcut_name(L"Chrome 2");
  ...
  // Shortcut 3: targets "iron.exe"; icon set to "obsidian.exe".
  test_properties_.set_target(iron_exe_);
  test_properties_.set_shortcut_name(L"Iron 3");
  ...
  // Retarget shortcuts: replace "obsidian.exe" with "manganese.exe".
  // Relies on the fact that |test_properties_| has non-empty arguments.
  base::FilePath new_exe = manganese_exe_;
  ASSERT_TRUE(ShellUtil::RetargetShortcutsWithArgs(
      ShellUtil::SHORTCUT_LOCATION_DESKTOP, ShellUtil::CURRENT_USER,
...
TEST_F(ShellUtilShortcutTest, ClearShortcutArguments) {
  ...
  // Shortcut 2: targets "obsidian.exe"; has 1 argument in the allow list.
  test_properties_.set_shortcut_name(L"Chrome 2");
  test_properties_.set_arguments(L"--profile-directory=\"Profile 2\"");
  ASSERT_TRUE(ShellUtil::CreateOrUpdateShortcut(
      ShellUtil::SHORTCUT_LOCATION_DESKTOP, test_properties_,
  ...
  // Shortcut 3: targets "obsidian.exe"; has an unknown argument.
  ...
  // Shortcut 4: targets "obsidian.exe"; has both unknown and known arguments.
...
TEST_F(ShellUtilShortcutTest, ShortcutsAreNotHidden) {
  // Shortcut 1: targets "obsidian.exe"; not hidden.
  ...
  // Shortcut 2: targets "obsidian.exe"; hidden.
