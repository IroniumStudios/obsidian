...
class ShellUtil {
 public:
  ...
  // that it can be launched from Start->Run just by name (obsidian.exe).
  ...
  // |chrome_exe|: the full path to obsidian.exe
  ...
  // rules).
  //
  // |chrome_exe| The path to the currently installed (or running) obsidian.exe.
  ...
  // chrome_exe: The obsidian.exe path to register as default browser.
  ...
  //
  // |chrome_exe| full path to obsidian.exe.
