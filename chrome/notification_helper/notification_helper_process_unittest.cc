...
// which additionally tests if obsidian.exe can be successfully launched by
...
// obsidian.exe which unit_tests.exe already has, and it's undesired to make
// notification_helper_unittests.exe have data dependency on obsidian.exe.
