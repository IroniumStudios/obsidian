...
class ShellIntegrationWinMigrateShortcutTest : public testing::Test {
 ...
 protected:
  ...
  void SetUp() override {
    ...
    // This doesn't need to actually have a base name of "obsidian.exe".
  ...
  void CreateShortcuts() {
    ...
    // Shortcut 0 doesn't point to obsidian.exe and thus should never be migrated.
    ...
    // Shortcut 1 points to obsidian.exe and thus should be migrated.
    ...
    // Shortcut 2 points to obsidian.exe, but already has the right appid and thus
    ...
    // Shortcut 11 points to obsidian.exe, already has the right appid, and has
  ...
  // The path to a fake obsidian.exe.
