...
// Check if current obsidian.exe is already running as a browser process by trying
// to create a Global event with name same as full path of obsidian.exe. This
